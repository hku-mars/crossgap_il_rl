...
DESCRIPTION
    ...
    arbitrary initial raw_state, to a final raw_state described by (any combination
...
class SingleAxisTrajectory:
    ...
    class, which wraps three of these and allows to test input/raw_state
    feasibility.

    """

    def __init__(self, pos0, vel0, acc0):
        """Initialise the trajectory with starting raw_state."""
        self._p0 = pos0
        self._v0 = vel0
        self._a0 = acc0
        self._pf = 0
...
class StateFeasibilityResult:
    """An enumeration of the possible outcomes for the raw_state feasiblity test.
...
class RapidTrajectory:
    ...
    A quadrocopter raw_state interception trajectory. The trajectory starts at a
    raw_state defined by the vehicle's position, velocity, and acceleration. The
    ...
    The trajectory goal raw_state can include any combination of components from
    ...
    def __init__(self, pos0, vel0, acc0, gravity):
        ...
        Initialise the trajectory with the initial quadrocopter raw_state, and the
    ...
    def set_goal_position(self, pos):
        ...
        list the end raw_state as ``None`` in the argument, or use the function
    ...
    def set_goal_acceleration(self, acc):
        ...
        free, list the end raw_state as ``None`` in the argument, or use the
    ...
    def reset(self):
        ...
        try multiple trajectories from one initial raw_state.
